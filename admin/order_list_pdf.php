...
$receipt = 'receipt-'.$order_list[order_list_id];
...
$pdf->Cell(0,8,iconv( 'UTF-8','TIS-620','       ผู้รับสินค้า/บริการ                                 ผู้ส่งสินค้า/บริการ                                   ผู้รับเงิน'),0,10);

$pdf->Cell(0,5,iconv( 'UTF-8','',''),0,10);

$pdf->Cell(0,0,iconv( 'UTF-8','TIS-620','                                                                                                                         วันที่_______________'),0,10);
