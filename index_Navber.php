<div id="computer" class="visible-lg bg3" >
	<div class="container">
		<div class="row">
			<div class="col-md-4 text-white" style="padding-top: 10px;">
				<? echo $fixed[fixed_company]; ?> | <? echo $fixed[fixed_topic]; ?> 
			</div>
			<div class="col-md-8 text-right" style="padding-top: 5px;padding-bottom: 5px;">
				<?
				...
				while ($social 	= mysqli_fetch_array($social_QR)) {
					?>
					<span style="margin-right: 15px;" class="hide1" title="<?php echo $social[social_name]; ?>" >
						<?
						if (isset($social[social_link])&&$social[social_link]!='') {

							if ($social[social_type]=='Tel') {
								?>
								<a style="color: white;"  href="tel:<?php echo $social[social_link]; ?>" target="_blank"> 
									<?
									if (isset($social[social_photo])&&$social[social_photo]!='') {
										?>
										<img style="height:20px;" src="cloud/social_photo/<?php echo $social[social_photo]; ?>" /> 
										<?
									}
									else{
								...
								?>
								<a style="color: white;"  href="http://<?php echo $social[social_link]; ?>" target="_blank"> 
									<?
									if (isset($social[social_photo])&&$social[social_photo]!='') {
										?>
										<img style="height:20px;" src="cloud/social_photo/<?php echo $social[social_photo]; ?>" /> 
				...
				?>
				<a href="product_cart.php" class="btn btn-main  btn-sm">
				...
				if (trim($_SESSION['member_online_id'])!=""&&isset($_SESSION['member_online_id'])) {
					...
					<span class="dropauto dropdown ">
						<a class="dropdown-toggle btn btn-main  btn-sm" data-toggle="dropdown" href="#">
					...
					?>
					<a style="margin-right: " class="btn btn-main  btn-sm" href="#" data-toggle="modal" data-target="#login_modal" data-whatever="@mdo">  
						<? if($_SESSION[Language]== "Thailand"){echo "ล๊อกอิน"; } else{echo "Login"; } ?> 
					</a>
					<a class="btn btn-main  btn-sm" href="signup.php">  
			...
			<div class="collapse navbar-collapse">
				<div class="navbar-header">
					...
					if (isset($fixed[fixed_navlogo])&&trim($fixed[fixed_navlogo])!='') {
						?>
						<a class="navbar-brand no-padding" style="padding-left: 0px !important;padding-top: 5px;"  href="http://<? echo $fixed[fixed_website] ?>" >
							<img style="height: 70px;" src="cloud/fixed_navlogo/<?php echo $fixed[fixed_navlogo]; ?>" />
						</a>
						<?
					}
				...
				<form class="navbar-form navbar-right" action="product.php" style="padding-top: 22px;margin-top: 0px;">
					<div class="input-group">
						...
						<div class="input-group-btn">
							<button style="background-color: white;color: black;border-left: 0px;" class="btn btn-default" type="submit">
								<i class="glyphicon glyphicon-search size13" style="margin-top: -3px;"></i>
							</button>
						</div>
					</div>
				</form> 
