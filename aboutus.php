...
<head>
	...
	<title> <? if($_SESSION[Language]== "Thailand"){echo "เกี่ยวกับเรา"; } else{echo "about us"; } ?>  <? echo $fixed[fixed_company]; ?> - <? echo $fixed[fixed_topic]; ?> | <? echo $fixed[fixed_website]; ?> </title>
	...
	<div class="container">
		...
		<div class="row margintop15">
			...
			<div class="col-md-10 review">
				<?
				$gallery_SL = " SELECT * FROM gallery WHERE gallery_code = 'aboutus' ORDER BY gallery_sort IS NULL ASC, gallery_sort ASC";
				...
				while ($gallery 	= mysqli_fetch_array($gallery_QR)) {
					...
					if (isset($gallery[gallery_video])&&trim($gallery[gallery_video])!='') {
						?>
						<div class="marginbottom15">
							<video  height="auto" controls><source src="cloud/gallery_video/<? echo $gallery[gallery_video]; ?>" type="video/mp4">Your browser does not support HTML5 video.
							</video>
						</div>
						<?
					}
		...
		<div class="row hidden-sm hidden-xs margintop30 text1" >
			<div class="col-md-12">
				<ul class="breadcrumb" style="margin-bottom: 0px;">
					...
					<li class="active"><a href="aboutus.php"> <? if($_SESSION[Language]== "Thailand"){echo "เกี่ยวกับเรา"; } else{echo "about us"; } ?> </a></li>
				</ul>
			</div>
		</div>
	</div>
